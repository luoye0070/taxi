...
<table id="usertable" style="width:1100px;height:auto"
       title="image" iconCls="icon-edit" singleSelect="true"
       idField="id" url="${resource()}/image/datajson">
    <thead>
    <tr>
        
        <th field="minurl" width="100" align="right" editor="text"><g:message code="image.minurl.label" default="Minurl" /></th>
        
        <th field="midurl" width="100" align="right" editor="text"><g:message code="image.midurl.label" default="Midurl" /></th>
        
        <th field="maxurl" width="100" align="right" editor="text"><g:message code="image.maxurl.label" default="Maxurl" /></th>
        
        <th field="gread" width="100" align="right" editor="text"><g:message code="image.gread.label" default="Gread" /></th>
