...
<table id="usertable" style="width:1100px;height:auto"
       title="demand" iconCls="icon-edit" singleSelect="true"
       idField="id" url="${resource()}/demand/datajson">
    <thead>
    <tr>
        
        <th field="nickName" width="100" align="right" editor="text"><g:message code="demand.nickName.label" default="Nick Name" /></th>
        
        <th field="phoneNum" width="100" align="right" editor="text"><g:message code="demand.phoneNum.label" default="Phone Num" /></th>
        ...
        <th field="longitude" width="100" align="right" editor="text"><g:message code="demand.longitude.label" default="Longitude" /></th>
        
        <th field="serverTime" width="100" align="right" editor="text"><g:message code="demand.serverTime.label" default="Server Time" /></th>
        
        <th field="time" width="100" align="right" editor="text"><g:message code="demand.time.label" default="Time" /></th>
