	...
	<body>
		...
		<div id="show-route" class="content scaffold-show" role="main">
			...
			<ol class="property-list route">
				...
				<g:if test="${routeInstance?.fromStation}">
				<li class="fieldcontain">
					<span id="fromStation-label" class="property-label"><g:message code="route.fromStation.label" default="From Station" /></span>
					
						<span class="property-value" aria-labelledby="fromStation-label"><g:fieldValue bean="${routeInstance}" field="fromStation"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${routeInstance?.toStation}">
				<li class="fieldcontain">
					<span id="toStation-label" class="property-label"><g:message code="route.toStation.label" default="To Station" /></span>
					
						<span class="property-value" aria-labelledby="toStation-label"><g:fieldValue bean="${routeInstance}" field="toStation"/></span>
