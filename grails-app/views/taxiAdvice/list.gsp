            ...
            $('#usertable').datagrid({
                ...
                handler:function(){
                    ...
                    $.messager.confirm('请确认', '您要删除当前所选项目？', function(r) {
                            ...
                            {
                            $.ajax({
                                url : '${resource()}/taxiAdvice/delete',
                                data : {id:row.id},
                                cache : false,
                                dataType : "json",
                                type : "POST",
...
<table id="usertable" style="width:1100px;height:auto"
       title="taxiAdvice" iconCls="icon-edit" singleSelect="true"
       idField="id" url="${resource()}/taxiAdvice/datajson">
    <thead>
    <tr>
        
        <th field="taxiPhone" width="100" align="right" editor="text"><g:message code="taxiAdvice.taxiPhone.label" default="Taxi Phone" /></th>
        
        <th field="advice" width="100" align="right" editor="text"><g:message code="taxiAdvice.advice.label" default="Advice" /></th>
        
        <th field="time" width="100" align="right" editor="text"><g:message code="taxiAdvice.time.label" default="Time" /></th>
