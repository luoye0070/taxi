    ...
    <script>
        ...
        $(function(){
            ...
            onAfterEdit : function(rowIndex, rowData, changes){
                ...
                {
                    var url = '${resource()}/personAuthority/';
                    if (rowData.id)
                    {
                        url += 'update';
                    }
...
<table id="usertable" style="width:1100px;height:auto"
       ...
       idField="id" url="${resource()}/personAuthority/datajson">
    <thead>
    <tr>
        
        <th field="authority" width="100" align="right" editor="text"><g:message code="personAuthority.authority.label" default="Authority" /></th>
        
        <th field="person" width="100" align="right" editor="text"><g:message code="personAuthority.person.label" default="Person" /></th>
