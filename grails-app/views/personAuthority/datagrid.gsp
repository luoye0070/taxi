...
<head>
    ...
    <script>
        ...
        $(function(){
            $('#datagrid').datagrid({
                title:"personAuthority",
                url:"${resource()}/personAuthority/datajson",
                rownumbers:true,
                ...
                columns:[[
                    ...
                    {title:'<g:message code="personAuthority.authority.label" default="Authority" />',field:'authority',width:100,sortable:true},
                    
                    {title:'<g:message code="personAuthority.person.label" default="Person" />',field:'person',width:100,sortable:true}
                ...
                toolbar:[{
                    ...
                    handler:function(){
                        $('#save').form('clear');
                        $('#create').dialog("open")
                        url = '${resource()}/personAuthority/save'
                    }
                },'-',{
                    text:'删除',
                    iconCls:'icon-remove',
                    handler:function(){
                        ...
                        $.messager.confirm('请确认', '您要删除当前所选项目？', function(r) {
                                ...
                                {
                                $.ajax({
                                    url : '${resource()}/personAuthority/delete',
                                    data : {id:row.id},
                                    cache : false,
                                    dataType : "json",
                                    type : "POST",
        ...
        $('#datagrid').datagrid('clearSelections')
                        $('#create').dialog('open');
            url = '${resource()}/personAuthority/update'
                        $('#save').form('load',{
            id:rowData.id,
    ...
    <div style="background:#fafafa;padding:10px;width:300px;height:300px;">
        <form id="save" method="post" novalidate>
            ...
            <div>
                ...
                <label for="authority"><g:message code="personAuthority.authority.label" default="Authority" /></label>
            ...
            <div>
                ...
                <label for="person"><g:message code="personAuthority.person.label" default="Person" /></label>
