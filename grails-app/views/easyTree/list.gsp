...
<table id="usertable" style="width:1100px;height:auto"
       ...
       idField="id" url="${resource()}/easyTree/datajson">
    <thead>
    <tr>
        
        <th field="text" width="100" align="right" editor="text"><g:message code="easyTree.text.label" default="Text" /></th>
        
        <th field="attributes" width="100" align="right" editor="text"><g:message code="easyTree.attributes.label" default="Attributes" /></th>
        
        <th field="state" width="100" align="right" editor="text"><g:message code="easyTree.state.label" default="State" /></th>
        
        <th field="pid" width="100" align="right" editor="text"><g:message code="easyTree.pid.label" default="Pid" /></th>
