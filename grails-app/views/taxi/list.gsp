...
<table id="usertable" style="width:1100px;height:auto"
       title="taxi" iconCls="icon-edit" singleSelect="true"
       idField="id" url="${resource()}/taxi/datajson">
    <thead>
    <tr>
        
        <th field="licence" width="100" align="right" editor="text"><g:message code="taxi.licence.label" default="Licence" /></th>
        
        <th field="password" width="100" align="right" editor="text"><g:message code="taxi.password.label" default="Password" /></th>
        
        <th field="taxiPhone" width="100" align="right" editor="text"><g:message code="taxi.taxiPhone.label" default="Taxi Phone" /></th>
        
        <th field="name" width="100" align="right" editor="text"><g:message code="taxi.name.label" default="Name" /></th>
        
        <th field="time" width="100" align="right" editor="text"><g:message code="taxi.time.label" default="Time" /></th>
