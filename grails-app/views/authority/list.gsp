...
<table id="usertable" style="width:1100px;height:auto"
       ...
       idField="id" url="${resource()}/authority/datajson">
    <thead>
    <tr>
        
        <th field="authority" width="100" align="right" editor="text"><g:message code="authority.authority.label" default="Authority" /></th>
