...
<table id="usertable" style="width:1100px;height:auto"
       ...
       idField="id" url="${resource()}/requestmap/datajson">
    <thead>
    <tr>
        
        <th field="url" width="100" align="right" editor="text"><g:message code="requestmap.url.label" default="Url" /></th>
        
        <th field="configAttribute" width="100" align="right" editor="text"><g:message code="requestmap.configAttribute.label" default="Config Attribute" /></th>
