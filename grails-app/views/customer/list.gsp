...
<table id="usertable" style="width:1100px;height:auto"
       title="customer" iconCls="icon-edit" singleSelect="true"
       idField="id" url="${resource()}/customer/datajson">
    <thead>
    <tr>
        
        <th field="nickName" width="100" align="right" editor="text"><g:message code="customer.nickName.label" default="Nick Name" /></th>
        
        <th field="phoneNum" width="100" align="right" editor="text"><g:message code="customer.phoneNum.label" default="Phone Num" /></th>
        
        <th field="password" width="100" align="right" editor="text"><g:message code="customer.password.label" default="Password" /></th>
