            ...
            $('#usertable').datagrid({
                ...
                handler:function(){
                    ...
                    $.messager.confirm('请确认', '您要删除当前所选项目？', function(r) {
                            ...
                            {
                            $.ajax({
                                url : '${resource()}/invalidation/delete',
                                data : {id:row.id},
                                cache : false,
                                dataType : "json",
                                type : "POST",
...
<table id="usertable" style="width:1100px;height:auto"
       title="invalidation" iconCls="icon-edit" singleSelect="true"
       idField="id" url="${resource()}/invalidation/datajson">
    <thead>
    <tr>
        
        <th field="latitude" width="100" align="right" editor="text"><g:message code="invalidation.latitude.label" default="Latitude" /></th>
        
        <th field="longitude" width="100" align="right" editor="text"><g:message code="invalidation.longitude.label" default="Longitude" /></th>
        
        <th field="phoneNum" width="100" align="right" editor="text"><g:message code="invalidation.phoneNum.label" default="Phone Num" /></th>
        
        <th field="state" width="100" align="right" editor="text"><g:message code="invalidation.state.label" default="State" /></th>
        
        <th field="time" width="100" align="right" editor="text"><g:message code="invalidation.time.label" default="Time" /></th>
